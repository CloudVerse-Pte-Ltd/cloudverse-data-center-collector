...
IMAGE="${COLLECTOR_IMAGE:-ghcr.io/cloudverse-pte-ltd/cloudverse-data-center-collector@sha256:962da5285dd89640efee14cf4371218a5ccd63f3c8cb432ff49e9f79f98bf44c}"
while [ "$#" -gt 0 ]; do
  case "$1" in
