...
IMAGE="${COLLECTOR_IMAGE:-ghcr.io/cloudverse-pte-ltd/cloudverse-data-center-collector@sha256:fd60a7e884b96ba2d755a8de9cc2f3af3128c9acfd7aba71ead6c7e0a91260cc}"
while [ "$#" -gt 0 ]; do
  case "$1" in
