...
IMAGE="${COLLECTOR_IMAGE:-ghcr.io/cloudverse-pte-ltd/cloudverse-data-center-collector@sha256:e842d023a6aaa2b53728d4e10c1af5bf1ed01ea99ed76a0c81ce99a7dc61e00c}"
while [ "$#" -gt 0 ]; do
  case "$1" in
