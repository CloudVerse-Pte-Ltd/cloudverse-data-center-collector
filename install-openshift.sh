...
IMAGE="${COLLECTOR_IMAGE:-ghcr.io/cloudverse-pte-ltd/cloudverse-data-center-collector@sha256:0a5e375731d3ddea16b6bded46a4c4b6eef4063873b124e5329bc677401f9ab1}"
while [ "$#" -gt 0 ]; do
  case "$1" in
