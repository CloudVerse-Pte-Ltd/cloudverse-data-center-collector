...
IMAGE="${COLLECTOR_IMAGE:-ghcr.io/cloudverse-pte-ltd/cloudverse-data-center-collector@sha256:b7fc5ba4e7451a5290a543ea8cfcf56989364eb7e31787381532ac03632c25f8}"
while [ "$#" -gt 0 ]; do
  case "$1" in
