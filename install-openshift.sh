...
IMAGE="${COLLECTOR_IMAGE:-ghcr.io/cloudverse-pte-ltd/cloudverse-data-center-collector@sha256:0f3f897d14d5bcd2d45e8522ce846c484f7135501dc24c08192cee0b23aeee9f}"
while [ "$#" -gt 0 ]; do
  case "$1" in
